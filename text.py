...
national = [
    '''{location}: {f_test} difference was observed among the entries.''',
...
best_entries_text_when_better_than_checks = [
    '''Test entry {best_entry} recorded highest fibre yield {best_entry_value} followed by {other_best_entries} which is statistically on par with best check {best_checks}.''',
...
mean_entries_start_for_national_average = [
    '''Analysis on mean over locations and years mean (grand mean), ''',
...
mean_entries_end = [
    '''{f_test} differences among entries were observed.''',
    '''Entries were {f_test}.''',
    '''Difference among entries was {f_test}.'''
]
